        ...
        <Card className="p-5">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between py-2 border-b border-border">
              ...
              <span className="font-bold">{fmtPct(algebraic?.combinedTaxRate ?? 0)}</span>
            </div>
            <div className="flex justify-between py-2 border-b border-border">
            ...
            <div className="flex justify-between py-2">
              ...
              <span className="font-bold">{fmtUSD(projection?.totalFutureNominal ?? 0)}</span>
            </div>
          </div>
        </Card>
      </div>
                ...
                <tbody className="divide-y divide-border">
                  {scenarioProjections.map(scenario => (
                    ...
                    >
                      ...
                      <td className="p-3 text-right font-mono">{fmtUSD(scenario.totalPastLoss ?? 0)}</td>
                      <td className="p-3 text-right font-mono">{fmtUSD(scenario.totalFuturePV ?? 0)}</td>
                      <td className="p-3 text-right font-mono font-bold">{fmtUSD(scenario.totalEarningsLoss ?? 0)}</td>
                      <td className="p-3 text-right font-mono font-bold text-primary bg-primary/5">{fmtUSD(scenario.grandTotal ?? 0)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
