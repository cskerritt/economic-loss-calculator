...
export default function ForensicSuite() {
  ...
  const renderStep = () => {
    switch (WIZARD_STEPS[currentStep].id) {
      ...
      case 'earnings':
        return <EarningsStep earningsParams={earningsParams} setEarningsParams={setEarningsParams} dateCalc={dateCalc} algebraic={algebraic} workLifeFactor={workLifeFactor} isUnionMode={isUnionMode} setIsUnionMode={setIsUnionMode} pastActuals={pastActuals} setPastActuals={setPastActuals} dateOfInjury={caseInfo.dateOfInjury} dateOfTrial={caseInfo.dateOfTrial} dob={caseInfo.dob} fmtUSD={fmtUSD} fmtPct={fmtPct} />;
      case 'narratives':
